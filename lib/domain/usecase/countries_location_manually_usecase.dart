  ...
  static List<ChooseLocation> getCountriesCitiesLocationManually(
    ...
    return [
      ChooseLocation(
          ...
          flag: "🇦🇫",
          latitude: "34.5553",
          longitude: "69.2075"), // Kabul
      ChooseLocation(
          countryName: localize.albania,
          flag: "🇦🇱",
          latitude: "41.3275",
          longitude: "19.8189"), // Tirana
      ChooseLocation(
          countryName: localize.algeria,
          flag: "🇩🇿",
          latitude: "36.7538",
          longitude: "3.0422"), // Algiers
      ChooseLocation(
          countryName: localize.azerbaijan,
          flag: "🇦🇿",
          latitude: "40.4093",
          longitude: "49.8671"), // Baku
      ChooseLocation(
          countryName: localize.bahrain,
          flag: "🇧🇭",
          latitude: "26.2285",
          longitude: "50.5860"), // Manama
      ChooseLocation(
      ...
      ChooseLocation(
          ...
          flag: "🇧🇳",
          latitude: "4.9031",
          longitude: "114.9398"), // Bandar Seri Begawan
      ChooseLocation(
          countryName: localize.burkinaFaso,
          flag: "🇧🇫",
          latitude: "12.3686",
          longitude: "-1.5276"), // Ouagadougou
      ChooseLocation(
          countryName: localize.chad,
          flag: "🇹🇩",
          latitude: "12.1348",
          longitude: "15.0557"), // N'Djamena
      ChooseLocation(
          countryName: localize.comoros,
          flag: "🇰🇲",
          latitude: "-11.7172",
          longitude: "43.2473"), // Moroni
      ChooseLocation(
          countryName: localize.djibouti,
          flag: "🇩🇯",
          latitude: "11.5721",
          longitude: "43.1456"), // Djibouti City
      ChooseLocation(
      ...
      ChooseLocation(
          ...
          flag: "🇬🇲",
          latitude: "13.4549",
          longitude: "-16.5790"), // Banjul
      ChooseLocation(
          countryName: localize.guinea,
          flag: "🇬🇳",
          latitude: "9.6412",
          longitude: "-13.5784"), // Conakry
      ChooseLocation(
      ...
      ChooseLocation(
          ...
          flag: "🇮🇷",
          latitude: "35.6892",
          longitude: "51.3890"), // Tehran
      ChooseLocation(
          countryName: localize.iraq,
          flag: "🇮🇶",
          latitude: "33.3152",
          longitude: "44.3661"), // Baghdad
      ChooseLocation(
          countryName: localize.jordan,
          flag: "🇯🇴",
          latitude: "31.9516",
          longitude: "35.9236"), // Amman
      ChooseLocation(
          countryName: localize.kazakhstan,
          flag: "🇰🇿",
          latitude: "51.1694",
          longitude: "71.4491"), // Astana
      ChooseLocation(
          countryName: localize.kuwait,
          flag: "🇰🇼",
          latitude: "29.3759",
          longitude: "47.9774"), // Kuwait City
      ChooseLocation(
          countryName: localize.kyrgyzstan,
          flag: "🇰🇬",
          latitude: "42.8746",
          longitude: "74.5698"), // Bishkek
      ChooseLocation(
          countryName: localize.lebanon,
          flag: "🇱🇧",
          latitude: "33.8938",
          longitude: "35.5018"), // Beirut
      ChooseLocation(
          countryName: localize.libya,
          flag: "🇱🇾",
          latitude: "32.8872",
          longitude: "13.1913"), // Tripoli
      ChooseLocation(
      ...
      ChooseLocation(
          ...
          flag: "🇲🇻",
          latitude: "4.1755",
          longitude: "73.5093"), // Malé
      ChooseLocation(
          countryName: localize.mali,
          flag: "🇲🇱",
          latitude: "12.6392",
          longitude: "-8.0029"), // Bamako
      ChooseLocation(
          countryName: localize.mauritania,
          flag: "🇲🇷",
          latitude: "18.0735",
          longitude: "-15.9582"), // Nouakchott
      ChooseLocation(
          countryName: localize.morocco,
          flag: "🇲🇦",
          latitude: "33.5731",
          longitude: "-7.5898"), // Rabat
      ChooseLocation(
          countryName: localize.nigeria,
          flag: "🇳🇬",
          latitude: "9.0579",
          longitude: "7.4951"), // Abuja
      ChooseLocation(
          countryName: localize.oman,
          flag: "🇴🇲",
          latitude: "23.5859",
          longitude: "58.4059"), // Muscat
      ChooseLocation(
      ...
      ChooseLocation(
          ...
          flag: "🇵🇸",
          latitude: "31.7683",
          longitude: "35.2137"), // Jerusalem (disputed)
      ChooseLocation(
          countryName: localize.qatar,
          flag: "🇶🇦",
          latitude: "25.2760",
          longitude: "51.5200"), // Doha
      ChooseLocation(
      ...
      ChooseLocation(
          ...
          flag: "🇸🇴",
          latitude: "2.0469",
          longitude: "45.3182"), // Mogadishu
      ChooseLocation(
          countryName: localize.sudan,
          flag: "🇸🇩",
          latitude: "15.5007",
          longitude: "32.5599"), // Khartoum
      ChooseLocation(
          countryName: localize.syria,
          flag: "🇸🇾",
          latitude: "33.5138",
          longitude: "36.2765"), // Damascus
      ChooseLocation(
          countryName: localize.tajikistan,
          flag: "🇹🇯",
          latitude: "38.5598",
          longitude: "68.7870"), // Dushanbe
      ChooseLocation(
      ...
      ChooseLocation(
          ...
          flag: "🇺🇿",
          latitude: "41.2995",
          longitude: "69.2401"), // Tashkent
      ChooseLocation(
          countryName: localize.yemen,
          flag: "🇾🇪",
          latitude: "15.3694",
          longitude: "44.1910"), // Sana'a
      ChooseLocation(
          countryName: localize.other, flag: "🌍", latitude: "", longitude: ""),
    ];
  }
}
