...
class IslamMobApp extends StatefulWidget {
  const IslamMobApp({super.key, required this.hasConnectivity});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: widget.hasConnectivity
          ? myBox.get(DatabaseFieldConstant.selectedTimeZone) != null ||
                  myBox.get(DatabaseFieldConstant.selectedLanguage) != null
