...
@freezed
abstract class PrayTimingHeaderState with _$PrayTimingHeaderState {
  /// Creates a [PrayTimingHeaderState] with prayer timing and location information.
  ///
  /// Parameters:
