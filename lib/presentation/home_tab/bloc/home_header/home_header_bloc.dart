...
class HomeHeaderBloc extends Bloc<HomeHeaderEvent, HomeHeaderState> {
  ...
  String currentCountry() {
    return _box.get(DatabaseFieldLocationConstant.selectedCountry, defaultValue: "");
  }

  /// Returns the current selected city from the Hive box.
  String currentCity() {
    return _box.get(DatabaseFieldLocationConstant.selectedCity, defaultValue: "");
  }

  /// Returns the current selected sub-city from the Hive box.
  String currentSubCity() {
    return _box.get(DatabaseFieldLocationConstant.selectedSubCity, defaultValue: "");
  }
