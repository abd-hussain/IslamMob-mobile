...
class HomeTabSalahTimerView extends StatefulWidget {
  ...
  @override
  State<HomeTabSalahTimerView> createState() => _HomeTabSalahTimerViewState();
}

class _HomeTabSalahTimerViewState extends State<HomeTabSalahTimerView> {
  late Timer _timer;
  ...
  @override
  void didUpdateWidget(covariant HomeTabSalahTimerView oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        CustomText(
          title: "${IslamMobLocalizations.of(context).remeningTime} : ",
          fontSize: 12,
          fontWeight: FontWeight.bold,
        ),
        CustomText(
