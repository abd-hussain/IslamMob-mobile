...
class QuranPagesIndexBloc
  ...
  List<int> listOfBookMarkedPages = [];
  ...
  void _getListOfBookMarkedPages() {
    ...
    if (bookMarkedPages.isNotEmpty) {
      listOfBookMarkedPages = bookMarkedPages.cast<int>();
    }
  }

  List<String> getAllSowarName({required BuildContext context}) {
    return [
  ...
  List<String> getAllPartsName({required BuildContext context}) {
    return [
  ...
  SowrahType getSorahType(
    ...
    if (sorahName == AppLocalizations.of(context)!.quranSorahName2 ||
      ...
      return SowrahType.madanyeh;
    } else {
      return SowrahType.makyeh;
    }
  }
