...
class AzkarBase {
  ...
  List<AzkarModel> azkarList(AzkarSalahTimeState salahType) {
    final bool fajirOrMaghribSalah = salahType == const AzkarSalahTimeStateFajir() ||
    ...
    if (salahType == const AzkarSalahTimeStateFajir() || salahType == const AzkarSalahTimeStateSunrise()) {
