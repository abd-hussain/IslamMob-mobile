...
import 'package:islam_mob_adhan/src/data/time_components.dart';
import 'package:islam_mob_adhan/src/internal/solar_time.dart';
import 'package:islam_mob_adhan/src/madhab.dart';
import 'package:islam_mob_adhan/src/prayer.dart';
...
class PrayerTimes {
  ...
  DateTime _calculateAsr(SolarTime solarTime, DateTime date) {
    ...
    final timeComponents = TimeComponents.fromDouble(
      solarTime.afternoon(shadowLength),
    );
    return timeComponents.applyToDate(date);
  }
