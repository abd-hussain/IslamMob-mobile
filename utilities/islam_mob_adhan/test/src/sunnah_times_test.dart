...
void main() {
  test('Test SunnahTimes NewYork', () {
    final params = CalculationMethod.northAmerica.getParameters();
    ...
    expect(
      DateFormat.yMd().add_jm().format(todayPrayers.maghrib),
      '7/12/2015 8:32 PM',
    );
    ...
    expect(
      DateFormat.yMd().add_jm().format(tomorrowPrayers.fajr),
      '7/13/2015 4:43 AM',
    );
    ...
    expect(
      DateFormat.yMd().add_jm().format(sunnahTimes.middleOfTheNight),
      '7/13/2015 12:38 AM',
    );
    expect(
      DateFormat.yMd().add_jm().format(sunnahTimes.lastThirdOfTheNight),
      '7/13/2015 1:59 AM',
    );
  });
}
