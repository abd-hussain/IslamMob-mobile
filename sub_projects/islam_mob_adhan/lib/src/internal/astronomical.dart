...
class Astronomical {
  ...
  static double correctedTransit(double m0, double L, double theta0,
    ...
    final alpha = DoubleUtil.unwindAngle(interpolateAngles(/* value */ alpha2,
        /* previousValue */ alpha1, /* nextValue */ alpha3, /* factor */ m0));
