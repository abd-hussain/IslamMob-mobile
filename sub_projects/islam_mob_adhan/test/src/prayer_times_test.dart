...
//   test('Test PrayerTimes for Local Timezone Output When Not Setting utcOffset param', () {
//     final kushtia = Coordinates(23.9088, 89.1220);
//     final date = DateComponents(2020, 6, 12);
//     final params = CalculationMethod.karachi.getParameters();
//     params.madhab = Madhab.hanafi;
...
//     expect(DateFormat.jm().format(prayerTimes.timeForPrayer(Prayer.fajr) ?? DateTime.now()), '3:48 AM');
//     expect(DateFormat.jm().format(prayerTimes.timeForPrayer(Prayer.sunrise) ?? DateTime.now()), '5:16 AM');
//     expect(DateFormat.jm().format(prayerTimes.timeForPrayer(Prayer.dhuhr) ?? DateTime.now()), '12:04 PM');
//     expect(DateFormat.jm().format(prayerTimes.timeForPrayer(Prayer.asr) ?? DateTime.now()), '4:44 PM');
//     expect(DateFormat.jm().format(prayerTimes.timeForPrayer(Prayer.maghrib) ?? DateTime.now()), '6:51 PM');
//     expect(DateFormat.jm().format(prayerTimes.timeForPrayer(Prayer.isha) ?? DateTime.now()), '8:19 PM');
//   });
...
//     expect(prayerTimes.currentPrayerByDateTime(prayerTimes.sunrise), Prayer.sunrise);
//     expect(prayerTimes.currentPrayerByDateTime(prayerTimes.dhuhr), Prayer.dhuhr);
//     expect(prayerTimes.currentPrayerByDateTime(prayerTimes.asr), Prayer.asr);
//     expect(prayerTimes.currentPrayerByDateTime(prayerTimes.maghrib), Prayer.maghrib);
...
//     final prayerTimes = PrayerTimes.today(kushtia, params, utcOffset: kushtiaUtcOffset);

//     final now = DateTime.now().toUtc().add(kushtiaUtcOffset);
//     expect(prayerTimes.dateComponents, DateComponents(now.year, now.month, now.day));
...
//     final nyPrayerTimes = PrayerTimes.utcOffset(newYork, nyDate, nyParams, nyUtcOffset);
...
//     final newYork = Coordinates(35.7750, -78.6336);
//     final prayerTimes = PrayerTimes.today(newYork, CalculationMethod.north_america.getParameters());
...
//     final prayerTimes = PrayerTimes.today(newYork, CalculationMethod.moon_sighting_committee.getParameters());
//     print(prayerTimes.fajr);
//   });

//   test('Test PrayerTimes Invalid Coordinates', () {
//     final invalidCoordinates = Coordinates(90.7750, -78.6336);
//     expect(() => PrayerTimes.today(invalidCoordinates, CalculationMethod.karachi.getParameters()), throwsArgumentError);
//   });

//   test('Test PrayerTimes.daysSinceSolstice', () {
//     _daysSinceSolsticeTest(11, /* year */ 2016, /* month */ 1, /* day */ 1, /* latitude */ 1);
//     _daysSinceSolsticeTest(10, /* year */ 2015, /* month */ 12, /* day */ 31, /* latitude */ 1);
//     _daysSinceSolsticeTest(10, /* year */ 2016, /* month */ 12, /* day */ 31, /* latitude */ 1);
//     _daysSinceSolsticeTest(0, /* year */ 2016, /* month */ 12, /* day */ 21, /* latitude */ 1);
//     _daysSinceSolsticeTest(1, /* year */ 2016, /* month */ 12, /* day */ 22, /* latitude */ 1);
//     _daysSinceSolsticeTest(71, /* year */ 2016, /* month */ 3, /* day */ 1, /* latitude */ 1);
//     _daysSinceSolsticeTest(70, /* year */ 2015, /* month */ 3, /* day */ 1, /* latitude */ 1);
//     _daysSinceSolsticeTest(365, /* year */ 2016, /* month */ 12, /* day */ 20, /* latitude */ 1);
//     _daysSinceSolsticeTest(364, /* year */ 2015, /* month */ 12, /* day */ 20, /* latitude */ 1);

//     _daysSinceSolsticeTest(0, /* year */ 2015, /* month */ 6, /* day */ 21, /* latitude */ -1);
//     _daysSinceSolsticeTest(0, /* year */ 2016, /* month */ 6, /* day */ 21, /* latitude */ -1);
//     _daysSinceSolsticeTest(364, /* year */ 2015, /* month */ 6, /* day */ 20, /* latitude */ -1);
//     _daysSinceSolsticeTest(365, /* year */ 2016, /* month */ 6, /* day */ 20, /* latitude */ -1);
//   });
// }

// void _daysSinceSolsticeTest(int value, int year, int month, int day, double latitude) {
...
//   expect(PrayerTimes.daysSinceSolstice(date.dayOfYear, date.year, latitude), value);
// }

// TZDateTime parseTzDateTimeWithoutEffect(String formatPattern, String formattedDateTimeString, Location locationTz) {
//   final dateTimeObject = DateFormat(formatPattern).parse(formattedDateTimeString);
//   return TZDateTime(locationTz, dateTimeObject.year, dateTimeObject.month, dateTimeObject.day, dateTimeObject.hour,
//       dateTimeObject.minute, dateTimeObject.second);
// }

// bool isTimesDifferenceWithinVarianceMinutes(TZDateTime time1, TZDateTime time2, int variance) {
//   return time1.difference(time2).inMinutes <= variance && (variance * -1) <= time1.difference(time2).inMinutes;
// }
